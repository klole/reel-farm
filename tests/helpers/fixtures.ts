...
export async function createSyntheticFixtureDirectory(directory = resolve(process.env.CH001_EVIDENCE_DIR ?? "artifacts/ch001r3/local", "fixtures")): Promise<{ portrait: string; landscape: string; square: string }> {
  ...
  await writeFile(resolve(directory, "FIXTURES.md"), "Synthetic SVG-derived JPEG fixtures generated locally for CH-001R-r3; no external media or provider was used.\n", { mode: 0o640 });
